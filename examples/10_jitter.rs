...
#[derive(Component)]
struct JitterTestMarker;

fn setup_jitter(mut commands: Commands) {
    // Spawn a RigidBody that we test if it will experience jitter
    commands.spawn((
        ...
        ColliderDensity(1.0),
        LinearVelocity(Vec3::new(0.0, 0.0, -1.0)),
    ));
}
